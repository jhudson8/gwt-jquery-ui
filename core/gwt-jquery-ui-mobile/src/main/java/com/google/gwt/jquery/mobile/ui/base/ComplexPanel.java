...
public abstract class ComplexPanel extends Panel implements IndexedPanel {
	...
	/**
	 * This method was used by subclasses to insert a new child Widget. It is
	 * now deprecated because it was ambiguous whether the <code>child</code>
	 * should be appended to <code>container</code> element versus inserted into
